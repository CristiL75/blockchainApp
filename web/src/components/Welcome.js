        ...
        <div className="flex w-full justify-center items-center">
            <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
                <div className="flex flex-1 justify-start flex-col mf:mr-10">
                    ...
                    <div className="grid sm:grid-cols-3 grid-cols-2 w-full mt-10">
                        ...
                        <div className={`sm:rounded-tr-2xl ${commonStyles}`}>
                            <SiEthereum fontSize={21} color="#fff" /> Ethereum
                        </div>
                ...
                <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
                    ...
                    <div className="p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphis">
                    <Input placeholder="Address To" name="addressTo" type="text" value={formData.addressTo} handleChange={handleChange} />
                        ...
                        {isLoading ? (
                            ...
                            <button
                                ...
                                className="text-white w-full mt-2 border-[1px] p-2 border-[#3d47v] rounded-full cursor-pointer"
                            >
                                Send now
                            </button>
                        )}
